                    ...
                    return {
                        items: {
                            ...
                            kick: {
                                name: "Kick",
                                visible: function () {
                                    var me = window.bonzis && window.bonzis[window.guid];
                                    return !!(me && me.userPublic && me.userPublic.flags && me.userPublic.flags.admin && self.id !== window.guid);
                                },
                                callback: function () {
                                    socket.emit("command", { z: window.generateTSString(), list: ["kick", self.userPublic.name] });
                                },
                            },
                            ban: {
                                name: "Ban (1 Day)",
                                ...
                                callback: function () {
                                    socket.emit("command", { z: window.generateTSString(), list: ["ban", self.userPublic.name] });
                                },
                            },
                        },
                    };
