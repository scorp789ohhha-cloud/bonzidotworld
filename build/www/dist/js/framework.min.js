            ...
            (this.x = coords.x * this.rng()),
                ...
                $.contextMenu({
                    ...
                    build: function (ignoredTrigger, ignoredEvent) {
                        var isAdmin = !!(window.bonzis && window.bonzis[window.guid] && window.bonzis[window.guid].userPublic && window.bonzis[window.guid].userPublic.flags && window.bonzis[window.guid].userPublic.flags.admin);
                        var isOther = _this2.id !== window.guid;
                        var items = {
                            cancel: {
                                name: "Cancel",
                                callback: function () {
                        ...
                        if (isAdmin && isOther) {
                            ...
                            items.kick = {
                                name: "Kick",
                                callback: function () {
                                    socket.emit("command", { z: window.generateTSString(), list: ["kick", _this2.guid] });
                                },
                            };
                            items.ban = {
                                name: "Ban (1 Day)",
                                callback: function () {
                                    socket.emit("command", { z: window.generateTSString(), list: ["ban", _this2.guid] });
                                },
                            };
                        } else {
                            items.sep1 = "--------";
                            items.kick = { name: "Kick", disabled: true, callback: function() {} };
                            items.ban = { name: "Ban (1 Day)", disabled: true, callback: function() {} };
                        }
                        return { items: items };
                    },
        ...
        return (
            (Bonzi.prototype.getContextMenu = function () {
                ...
                return function (ignoredTrigger, ignoredEvent) {
                    var isAdmin = !!(window.bonzis && window.bonzis[window.guid] && window.bonzis[window.guid].userPublic && window.bonzis[window.guid].userPublic.flags && window.bonzis[window.guid].userPublic.flags.admin);
                    var isOther = self.id !== window.guid;
                    var items = {
                        cancel: {
                            name: "Cancel",
                            callback: function () {
                    ...
                    if (isAdmin && isOther) {
                        ...
                        items.kick = {
                            name: "Kick",
                            callback: function () {
                                socket.emit("command", { z: window.generateTSString(), list: ["kick", self.guid] });
                            },
                        };
                        items.ban = {
                            name: "Ban (1 Day)",
                            callback: function () {
                                socket.emit("command", { z: window.generateTSString(), list: ["ban", self.guid] });
                            },
                        };
                    } else {
                        items.sep1 = "--------";
            ...
            _createClass(Bonzi, [
                ...
                },
                {
                    ...
                    value: function (text, say, allowHtml, extra) {
                        ...
                        try {
                            (_this3.goingToSpeak = !0),
                                (_this3.$sapiProgress = _this3.$dialogCont.find(".sapi-loading-bar").length ? _this3.$dialogCont.find(".sapi-loading-bar") : (function(p){ p.css({display:"block",width:"100%",margin:"4px 0 0 0"}); _this3.$dialogCont.append(p); return p; })($("<progress class='sapi-loading-bar'></progress>"))),
                ...
                },
                {
                    key: "updateName",
                    value: function () {
                        this.userPublic && this.userPublic.flags ? this.userPublic.flags && this.userPublic.flags.admin && this.$nameIcon.html("<i class='fas fa-hammer' title='Godmode' />") : this.$nameIcon.html(""),
